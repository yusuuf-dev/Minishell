...
./cmds/ft_env.c ./costum_utils/ft_isspace_to_space.c ./cmds/ft_exit.c ./costum_utils/skip_quotes_split.c \
./costum_utils/heredoc_delimiter.c ./costum_utils/found_pipe.c ./costum_utils/redirections_parsing_utils.c \
./utils/ft_isalnum.c ./utils/ft_isalpha.c ./costum_utils/utils_atoi.c ./costum_utils/ft_pipes.c \
./costum_utils/ft_setup.c ./costum_utils/ft_malloc.c ./utils/ft_memset.c ./costum_utils/signals_handler.c ./costum_utils/check_syntax.c ./utils/ft_substr.c \
...
./costum_utils/redirections_parsing.c ./costum_utils/found_quotes.c ./cmds/ft_export_utils.c ./costum_utils/valid_var.c
